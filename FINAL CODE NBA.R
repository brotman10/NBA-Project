...
clusters2=data.frame(rownames(nba_def_C1),km.8$cluster)
View(clusters2)
...
clusters3=data.frame(rownames(nba_ovr_C1),km.7$cluster)
View(clusters3)
...
nba_off_PF1= nba_off_PF[,c(22,23)] 
...
kmeans.ani(nba_off_PF1, centers = 7, pch = 1:7, col = 1:7,)
clusters=data.frame(rownames(nba_off_PF1),km.7$cluster)
View(clusters)
...
kmeans.ani(nba_off_PF1, centers = 5, pch = 1:5, col = 1:5,)
clusters1=data.frame(rownames(nba_off_PF1),km.5$cluster)
View(clusters1)
...
clusters3=data.frame(rownames(nba_ovr_PF1),km.5$cluster)
View(clusters3)
...
clusters2=data.frame(rownames(nba_PF1),km.6$cluster)
View(clusters2)
...
kmeans.ani(nba_SF1, centers = 5, pch = 1:5, col = 1:5,)
clusters1=data.frame(rownames(nba_SF1),km.5$cluster)
View(clusters1)

#### PTS & TS_Per *** 
View(nba_SF)

nba_SF1 = nba_SF[,c(28,30)]
rownames(nba_SF1)= nba_SF$Player
plot(nba_SF1)
...
kmeans.ani(nba_SF1, centers = 5, pch = 1:5, col = 1:5,)
clusters4=data.frame(rownames(nba_SF1),km.5$cluster)
View(clusters4)
...
kmeans.ani(nba_SF1, centers = 5, pch = 1:5, col = 1:5,)
clusters2=data.frame(rownames(nba_SF1),km.5$cluster)
View(clusters2)
...
data<- data.frame("Team" = Teams, "Total Overpaid/Underpaid budget per team" = Overpayment)
print(data)
...
ggplot(data = nba, aes(x = SalaryUSD, y = VORP)) +
  geom_point() + geom_smooth(method='lm', color = "red", fill = "purple", formula = y~poly(x,3)) + labs (x = " Salaries of NBA Players (in USD)", y = " Value of Replacing Players (VORP)") + ggtitle("Analyzing the relationship between Players' Salaries and Value of Replacing Players (VORP)")

## OWS(X) with respect to VORP(Y)
fig_ows <- ggplot(data = nba, aes(x = nba$OWS, y = VORP)) +
  geom_point() + geom_smooth(method='lm', color = "red", fill = "purple") + labs (x = "Offensive Win Shares", y = " Value of Replacing Players (VORP)")

## DWS(X) with respect to VORP(Y)
fig_dws <- ggplot(data = nba, aes(x = nba$DWS, y = VORP)) +
  geom_point() + geom_smooth(method='lm', color = "red", fill = "purple") + labs (x = "Defensive Win Shares", y = " Value of Replacing Players (VORP)")
